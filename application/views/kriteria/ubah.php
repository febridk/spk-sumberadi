                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="nama_kriteria" id="nama_kriteria" value="<?= set_value('nama_kriteria') ?  set_value('nama_kriteria') :  $kriteria->nama_kriteria ?>" placeholder="Nama Kriteria">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="prosentase_kriteria" id="prosentase_kriteria" min="1" value="<?= set_value('prosentase_kriteria') ? set_value('prosentase_kriteria') : $kriteria->prosentase_kriteria ?>" placeholder="Prosentase">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="bobot_core" id="bobot_core" min="1" value="<?= set_value('bobot_core') ? set_value('bobot_core') : $kriteria->bobot_core ?>" placeholder="Bobot Core">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="bobot_secondary" id="bobot_secondary" min="1" value="<?= set_value('bobot_secondary') ? set_value('bobot_secondary') : $kriteria->bobot_secondary ?>" placeholder="Bobot Secondary">
